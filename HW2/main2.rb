...
if animal == 'Cat'
  puts "#{animal} says MEOWWW!!"
elsif animal == 'Dog'
  puts "#{animal} says WOOFF!!"
elsif animal == 'Cow'
  puts "#{animal} says MOOOOO!!"
elsif animal == 'Snake'
  puts "#{animal} says SssSsssSsss!!"
else
  puts 'There is no those animal or enter animal upcase'
end
...
num = gets.chomp.to_i * 256
  puts "Result: #{num}"
  if num.to_s.match(/(1.*){2,}/)
    puts "Match found!"
    break
  end
end
...
print 'Enter your favorite cities and separate by commas: '
fav_cities = gets.split
puts fav_cities.sort
